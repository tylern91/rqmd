...
- The shipped default is `n_ctx=2048` for the reranker (`LlamaCppConfig::default`); `n_ctx=512` is a documented tuning option for the 448 MiB KV budget at the 14-layer split point, not the default.
